\doxysection{doxy\+\_\+core/\+Inc/\+CLController.h File Reference}
\hypertarget{_c_l_controller_8h}{}\label{_c_l_controller_8h}\index{doxy\_core/Inc/CLController.h@{doxy\_core/Inc/CLController.h}}
...
\item 
class \mbox{\hyperlink{struct_c_l_controller}{CLController}}
\begin{DoxyCompactList}\small\item\em An implementation of a PIDF (F = Feedforward constant) closed loop controller. It is a generic controller that takes in a measurement, controller constants, and a setpoint and outputs an effort to be sent to the actuator. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
uint32\+\_\+t \mbox{\hyperlink{_c_l_controller_8h_a52ab2a8ea3461a6c03a8ae4bdc418e2a}{run}} (\mbox{\hyperlink{struct_c_l_controller}{CLController}} \texorpdfstring{$\ast$}{*}con, int32\+\_\+t measured)
\item 
void \mbox{\hyperlink{_c_l_controller_8h_a778c8284b941b1f1135208e8d748600d}{reset\+\_\+controller}} (\mbox{\hyperlink{struct_c_l_controller}{CLController}} \texorpdfstring{$\ast$}{*}con)
...
Definition in file \mbox{\hyperlink{_c_l_controller_8h_source}{CLController.\+h}}.



\doxysubsection{Function Documentation}
\Hypertarget{_c_l_controller_8h_a778c8284b941b1f1135208e8d748600d}\label{_c_l_controller_8h_a778c8284b941b1f1135208e8d748600d} 
\index{CLController.h@{CLController.h}!reset\_controller@{reset\_controller}}
\index{reset\_controller@{reset\_controller}!CLController.h@{CLController.h}}
...
\end{DoxyCode}
\Hypertarget{_c_l_controller_8h_a52ab2a8ea3461a6c03a8ae4bdc418e2a}\label{_c_l_controller_8h_a52ab2a8ea3461a6c03a8ae4bdc418e2a} 
\index{CLController.h@{CLController.h}!run@{run}}
\index{run@{run}!CLController.h@{CLController.h}}
